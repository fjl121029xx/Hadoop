...
@Description(name = "compare_rate", value = "_FUNC_(dimension,measure,dimen_mode,time_diff_type,measure_name) - Returns the mean of a set of numbers")
public class CompareRate extends UDAF {
    ...
    public static class Evaluator implements UDAFEvaluator {
        ...
        public boolean iterate(List<String> dimensions,
            ...
            String aggr_key = dimensions.stream().map(s -> {
                if (CompareRate.hasRD(s) || CompareRate.hasRD2(s)) {
                    return CompareRate.dayformat(s, dimen_mode);
                } else {
                    return s;
                }
...
//            if (time_diff_type != null) {
//                throw new RuntimeException(time_diff_type1 + "\r\n" + time_diff_type);
//            }
...
//                if (time_diff_type.equals("0")) {
                ...
                dog.forEach((key, aDouble) -> {
                    ...
                    String day = CompareRate.getTime(ca);
                    k[0] = CompareRate.dayformat(day, dimen_mode);
                ...
                dog.forEach((key, value) -> {
                    ...
                    if (value2 == 0.0) {
                        ...
                        result_dog.put(key, Double.toString((value - value2) / value2));
                    }
