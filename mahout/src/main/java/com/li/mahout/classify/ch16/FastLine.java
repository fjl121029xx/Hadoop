...
public class FastLine {
    ...
    public static FastLine read(ByteBuffer buf) throws IllegalAccessException {
        ...
        throw new IllegalAccessException("Not enough bytes in buffer");
    }
    ...
    public double getDouble(int field) {
        ...
        switch (size) {
            ...
            case 2:
                return (base.get(offset) - '0') * 10 + base.get(offset) - '0';
            default:
                double r = 0;
